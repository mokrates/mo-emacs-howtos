...
** Cursor blinking
*** GUI emacs
just disable it via menu and save your configuration. Alternatively:
`M-x cursor-blink-mode`.
*** Emacs in graphical terminal emulator
disable cursor blinking in your terminal configuration
*** Linux terminal
use this command[fn:1]:
#+BEGIN_SRC bash
  echo -e '\033[?17;0;64c'
#+END_SRC
